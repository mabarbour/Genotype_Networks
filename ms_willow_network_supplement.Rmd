...
```{r prepare, include = FALSE, echo=FALSE}
...
```{r gall size results summary, echo=FALSE}
anova(vLG.size.lm)
anova(rG.size.lm)
anova(aSG.size.lm)
```
...
```{r gall abundance negative binomial assumption, echo=FALSE}
...
```{r mvabund gall-trait associations, echo=FALSE}
...
```{r stepAIC galls-traits, echo=FALSE, results='asis'}
...
```{r identify gall-trait associations, eval=FALSE}
...
```{r visreg univariate gall-trait associations, eval=FALSE}
...
```{r gall size trait associations, echo=FALSE}
## gall size
...
```{r mv abund interactions explore, echo=FALSE}
...
```{r test linear models link abundance}
...
```{r composition analysis of gall-parasitoid links, echo=FALSE}
...
```{r mv abund interaction predictors, echo=FALSE}
...
```{r AIC model assessment, echo=FALSE}
...
```{r gall parasitism likelihood ratio tests, echo=FALSE}
